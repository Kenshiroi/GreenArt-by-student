 ...
 */
class getSousCommandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SousCommandeRepository' shared autowired service.
     *
     * @return \App\Repository\SousCommandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SousCommandeRepository.php';

        return $container->privates['App\\Repository\\SousCommandeRepository'] = new \App\Repository\SousCommandeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
