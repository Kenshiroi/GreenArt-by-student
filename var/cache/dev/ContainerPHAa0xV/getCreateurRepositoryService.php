 ...
 */
class getCreateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CreateurRepository' shared autowired service.
     *
     * @return \App\Repository\CreateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CreateurRepository.php';

        return $container->privates['App\\Repository\\CreateurRepository'] = new \App\Repository\CreateurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
